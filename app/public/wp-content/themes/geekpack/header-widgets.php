...
<body <?php body_class(); ?>>
	...
	<div class="header-section full">
		<div class="wrap">
			<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'geekpack-underscores' ); ?></a>
			...
			<header id="masthead" class="site-header inner">
				<div class="site-branding">
					...
					$geekpack_underscores_description = get_bloginfo( 'description', 'display' );
					if ( $geekpack_underscores_description || is_customize_preview() ) :
						?>
						<p class="site-description"><?php echo $geekpack_underscores_description; /* WPCS: xss ok. */ ?></p>
					<?php endif; ?>
				</div><!-- .site-branding -->
